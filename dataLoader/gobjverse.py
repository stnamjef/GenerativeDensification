...
class gobjverse(torch.utils.data.Dataset):
    def __init__(self, cfg):
        ...
        # scenes_one = np.array(sorted(self.metas.keys()))[20:21]
        # scenes_name = np.tile(scenes_one, 10000)
        # print('scenes_name', len(scenes_name))
        # scenes_name = ['101356']
    ...
    def __getitem__(self, index):
        ...
        # print('scene_info', scene_info['groups'])
        # print('src_view_id:', src_view_id)
