...
CO3D_RAW_ROOT = '/workspace/xiangyu/datasets/co3d/dataset' # change to where your CO3D data resides
CO3D_OUT_ROOT = './dataset/Co3D/' # change to your folder here
...
if __name__ == "__main__":
    for category in ["hydrant"]: # ["teddybear", "hydrant"]:#
