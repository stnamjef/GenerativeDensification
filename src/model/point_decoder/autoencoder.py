...
class UpscaleModule(PointModule):
    ...
    def forward(self, point: Point):
        ...
        delta_x = 0.1 * point.grid_size * torch.tanh(delta_x)
...
class SerializationModule(PointModule):
    def __init__(
        ...
        enable_residual_attribute: bool = True,
    ):
        super().__init__()
...
class GaussianModule(PointModule):
    def __init__(
        ...
        super().__init__()
        assert sh_degree <= 5, "sh_degree must be less than or equal to 5"
